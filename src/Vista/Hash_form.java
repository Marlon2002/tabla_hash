 ...
 * @author joseg
 */
public class Hash_form extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hash_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
